...
[Command(
    ...
    Name = Constants.CommandName_ProjectItems,
        ...
        IsAsync = true)]
public class ListUserStoriesAndTasksForProjectCommand : GitHubCommandBase
{
    ...
    protected override async Task OnExecute()
    {
        ...
        await GetItems(projectName, ownerId);
    }

    private async Task GetItems(string projectName, string ownerId)
    {
